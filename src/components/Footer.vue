    ...
    <footer class="footer">
        <div class="flex justify-between flex-padding">
            ...
            <div class="flex justify-end gap-5">
                ...
                <div class="f-icon">
                    <a href="https://github.com/TerezzaB" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
...
<style scoped>
footer { border-top: 1px solid var(--third-color); padding: 20px; font-weight: bold; }

.flex-padding { padding: 30px 60px; }
.f-icon:hover { transition: transform 0.3s; transform: scale(1.25); cursor: pointer; }
</style>